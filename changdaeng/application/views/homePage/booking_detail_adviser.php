            ...
            <h5 class="card-title text-left mb-4">1. การจองของคุณ</h5>
              <div class="col-12 text-left">
                  <div class="row">
                    ...
                    <div class="col-sm-4">
                      <input class=" vertical-spin " type="number" id="amount" name="amount"  value="1" data-bts-button-down-class="btn btn-secondary btn-outline" data-bts-button-up-class="btn btn-secondary btn-outline" onchange="totolPrice(1);" >
                    </div>
          ...
          <div class="card-body">
              ...
              <div class="row">
                <div class="price-col mt-4">
                    ...
                    <span class="price">
                        <span>฿</span>
                        <span id="bkPrice2"><?php echo $value->course_price; ?></span>
          ...
          $.ajax({
               ...
               success:function(res){
                    if(res.status != false){
                         ...
                         var rsComma = formatCurrency(rs.toFixed(2));
