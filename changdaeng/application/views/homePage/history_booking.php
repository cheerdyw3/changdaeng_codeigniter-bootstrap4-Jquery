                        ...
                        <div class="col-12">
                            ...
                            <div class="row">
                                ...
                                <div class="col-6 text-right">
                                    <form action="<?=base_url('main/payment1/')?>" method="post">
                                        ...
                                        <button type="button" class="btn btn-warning bt_cf" id="cancel_booking" value="<?php echo $value["booking_id"];?>">ยกเลิกการจอง</button>
                                    </form>
                                </div>
                            </div>
                        </div>
