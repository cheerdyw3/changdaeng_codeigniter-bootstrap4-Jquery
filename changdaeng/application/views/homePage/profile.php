    ...
    <?php foreach($query as $key => $value){ ?>
            ...
            <div class="row">
                <div class="col-md-4">
                    ...
                    <img src="<?php echo base_url('upload/member');?>/<?php echo $value->img;?>">
                ...
                <div class="col-md-6">
                    <div class="profile-head">
                        ...
                        <h6>สมาชิก</h6>
                        <p class="proile-rating">รหัสสมาชิก : <span><?php echo $value->member_id; ?></span></p>
                ...
                <div class="col-md-2">
                    <div class="col-md-12 mb-1" >   
                        <button type="button" class="profile-edit-btn pl-2 pr-2" value="แก้ไขโปรไฟล์"   
                            data-toggle="modal" data-target="#exampleModalCenter">แก้ไขโปรไฟล์
                        </button>
                    </div>
                </div>
            </div>
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <input type="hidden" class="form-control" id="member_id" name="member_id" value="<?php echo $value->member_id; ?>">
            ...
            <div class="modal fade" id="editTel" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <input type="hidden" class="form-control" id="member_id4" name="member_id4" value="<?php echo $value->member_id; ?>">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">ยกเลิก</button>
                                <button type="submit" class="btn btn-primary">บันทึก</button>
                            </div>
            ...
            <div class="modal fade" id="editEmail" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <input type="hidden" class="form-control" id="member_id2" name="member_id2" value="<?php echo $value->member_id; ?>">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">ยกเลิก</button>
                                <button type="submit" class="btn btn-primary">บันทึก</button>
                            </div>
            ...
            <div class="modal fade" id="editPass" tabindex="-1" role="dialog"
                    ...
                    <div class="modal-dialog modal-dialog-centered" role="document">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <input type="hidden" class="form-control" id="member_id3" name="member_id3" value="<?php echo $value->member_id; ?>">
                                <button type="button" class="btn btn-secondary" data-dismiss="modal">ยกเลิก</button>
                                <button type="submit" class="btn btn-primary">บันทึก</button>
                            </div>
                        ...
                        success: (data)=>{
                            if(data.status===true){
                                swal({
                                    ...
                                    location.replace("<?= base_url('main/profile');?>");
                                });
        ...
        submitHandler: (form,e)=>{
            ...
            swal({
                ...
                if(result.value){
                    $.ajax({
                        type: "post",
                        url: "<?= base_url('main/edit_member_passANDmail');?>", 
                        data: data,
                        dataType: 'json',
                        async: false,
                        cache: false,
    ...
    $('#frmEmail').validate({
        rules:{
            email2:{
                ...
                remote:{
                type: "POST",
                url: "<?=base_url('main/chk_mail_member2');?>",
                data:{
                    email2: function(){
                        return $("#email2").val();
                    }
    ...
    $('#frmTel').validate({
        rules:{
            tel1:{
                ...
                remote:{
                type: "POST",
                url: "<?=base_url('main/chk_tel_member2');?>",
                data:{
                    tel1: function(){
                        return $("#tel1").val();
                    }
