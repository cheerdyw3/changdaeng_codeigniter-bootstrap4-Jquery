...
<head>
    ...
    <title>changdeang-advicer</title>
    <!-- Bootstrap Core CSS -->
        ...
        <div class="login-register" style="background-color:#ecf0f1;">
            ...
            <div class="login-box">
                <div style="background-color:#ffffff;" class="p-5 shadow"> 
                    <form class="form-horizontal" id="frm_login" action="<?=base_url('adviser/chk_login')?>" method="POST">
                        <div class="form-group row">
                            <div class="col-sm-12">
                                <div class="input-group">
                                    ...
                                    <input type="email" class="form-control" name="email" id="email" placeholder="email" title="กรุณากรอกอีเมล" required>
                                </div>
