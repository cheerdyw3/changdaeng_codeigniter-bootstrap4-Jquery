                ...
                <div class="table-responsive m-t-40">
                    ...
                    <thead class="bg-dark">
                            <tr>
                                <th scope="col" data-tablesaw-sortable-col data-tablesaw-priority="9" class="text-center" width="5%" class="text-center" nowrap>id</th>
                            ...
                            <?php foreach ($data as $key => $value) { ?>
                                <tr>
                                    ...
                                    <td class="text-center">
                                        <img src="<?php echo base_url('upload/staffMassager/profile');?>/<?php echo $value["img"];?>" width="60px" height="60px">
                                    </td>
                                    <td>
                                        <div>ชื่อ : <?php echo $value["firstName"]." ".$value["lastName"];?></div>
                                        <div>เบอร์โทร : <?php echo $value["tell"];?></div>
                                        <div>ความสามารถ : <?php echo $value["course_name"];?></div>
                                        <div>วันที่สมัคร : <?= dateTimeThai(date("d M Y H:i", strtotime($value["startDate"])));?></div>
                                    ...
                                    <a href="javascript:void(0)" class="badge badge-success" alt="alert" onclick="appove_staff(true,<?= $value["staff_massager_id"];?>)">
                                            <i class="fas fa-minus-circle"> อนุมัติ</i>
                                        </a>
                                        <a href="javascript:void(0)" class="badge badge-danger" alt="alert" onclick="appove_staff(false,<?= $value["staff_massager_id"]; ?>)">
                                            ...
                                            <form class="form-horizontal upload_img" method="post" enctype="multipart/form-data" id="frmFindStaffMassager">
                                                    <div class="tab-pane p-20" id="image2<?=$key+1?>" role="tabpanel">
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="form-group row">
                                                                    ...
                                                                    <div class="col-md-10">
                                                                        <img src="<?=base_url('upload/staffMassager/IDCard/'.$value["IDCard"])?>" class="w-75">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
                                                        <div class="row">
                                                            <div class="col-md-12">
                                                                <div class="form-group row">
                                                                    <label class="control-label text-right col-md-2">สำเนาทะเบียนบ้าน</label>
                                                                    <div class="col-md-10">
                                                                        <img src="<?=base_url('upload/staffMassager/document/'.$value["document"])?>" class="w-75">
                                                                    </div>
                                                                </div>
                                                            </div>
                                                        </div>
