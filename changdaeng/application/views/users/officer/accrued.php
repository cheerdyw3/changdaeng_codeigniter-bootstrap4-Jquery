                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center"> 
                                                        <?php if($value["statusPayToAdviser"]==0){ ?>
                                                            <a href="javascript:void(0)" onclick="changeStatus(<?= $value['detail_list_id'];?>)" class="badge badge-primary">
                                                            ยังไม่ได้จ่าย
                                                            </a>
    ...
    function changeStatus(id){
        swal({
            ...
            if (result.value) {
                $.ajax({
                    type: "post",
                    url: "<?= base_url('officer/changeStatusAccrued');?>",
                    data: {"id":id},
                    dataType: 'json',
                    success: (data)=>{
                        if(data.status===true){
                            swal({
                                ...
                                location.replace("<?= base_url('officer/accrued');?>");
                            });
                        }else{
                            swal({
