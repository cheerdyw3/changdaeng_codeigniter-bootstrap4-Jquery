    ...
    <!-- <h3 class="text-themecolor">ประวัติการนวด</h3> -->
		<div class="card"> 
            <div class="row ml-3 mt-4">
                ...
                <button class="btn btn-success" id="btn_income_owner">ตกลง</button>
                <button class="btn btn-info ml-2" id="income_all_owner">ดูทั้งหมด</button>
...
<div class="modal" id="modal_income">
    <div class="modal-dialog">
        <form action="<?=base_url('officer/export_income_orderBy')?>" method="POST" target="_blank">
            <div class="modal-content">
                ...
                <div class="modal-footer">
                    ...
                    <a href="<?=base_url('officer/export_incomeAll')?>" target="_blank" class="btn btn-danger">พิมพ์ทั้งหมด</a>
                </div>
            </div>
        </form>
    </div>
