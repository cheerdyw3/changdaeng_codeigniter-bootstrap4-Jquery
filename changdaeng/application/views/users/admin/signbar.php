                    ...
                    <ul class="navbar-nav my-lg-0">
                        ...
                        <li class="nav-item dropdown">
                            <a class="nav-link dropdown-toggle waves-effect waves-dark" href="" data-toggle="dropdown"
                                aria-haspopup="true" aria-expanded="false"><img src="<?=base_url('upload/user1.jpg')?>"
                                    alt="user" class="profile-pic" /></a>
                            <div class="dropdown-menu dropdown-menu-right animated flipInY">
                                <ul class="dropdown-user">
                                    <li>
                                        <div class="dw-user-box">
                                            <div class="u-img"><img src="<?=base_url('upload/user1.jpg')?>" alt="user"></div>
                                            <div class="u-text">
                                                <h4>Steave Jobs</h4>
        ...
        <aside class="left-sidebar">
            ...
            <div class="scroll-sidebar">
                ...
                <nav class="sidebar-nav">
                    <ul id="sidebarnav">
                        <li class="user-profile"> <a class="has-arrow waves-effect waves-dark" href="#"
                                aria-expanded="false"><img src="<?=base_url('upload/user1.jpg')?>" alt="user" /><span
                                    class="hide-menu">Steave Jobs </span></a>
                        ...
                        <li> <a class="has-arrow waves-effect waves-dark" href="#" aria-expanded="false"><i
                                    class="mdi mdi-gauge"></i><span class="hide-menu">จัดการผู้ใช้ </span></a>
                            <ul aria-expanded="false" class="collapse">
                                <li class="active"></li> <a href="index.html">เจ้าของร้าน </a></li>
                                <li><a href="index2.html">เจ้าหน้าที่</a></li>
                                <li><a href="index3.html">พนักงานนวด</a></li>
                                <li><a href="index4.html">ไกด์</a></li>
                                <li><a href="index4.html">สมาชิก</a></li>
                                <li><a href="index4.html">บุคคลทั่วไป</a></li>
                            </ul>
                        </li>
